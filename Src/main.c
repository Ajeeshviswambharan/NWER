...
int main(void)
{
  ...
  /* definition and creation of uart_check */
  osSemaphoreDef(uart_check);
  uart_checkHandle = osSemaphoreCreate(osSemaphore(uart_check), 1);
...
/* USER CODE BEGIN Header_motor_cyclic */
/**
...
/* USER CODE BEGIN Header_sensor_cyclic */
/**
...
/* USER CODE BEGIN Header_gps_cyclic */
/**
* @brief Function implementing the GPS_Value thread.
* @param argument: Not used
* @retval None
*/
